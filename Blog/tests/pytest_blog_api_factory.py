...
class TestBlogApi:
    ...
    def set_up(self, user_factory):
        user_1 = user_factory(email="staff@mail.com", is_staff=True, is_activated=True)
        user_2 = user_factory(email="business@mail.com", is_staff=True, is_activated=True)
        user_3 = user_factory(email="normal@mail.com", is_activated=True)
        data = {
            'owner': user_1,
            'title': 'Third Post',
